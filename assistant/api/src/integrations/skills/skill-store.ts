 ...
 */
export const setSkillEnabled = async (name: string, enabled: boolean): Promise<SkillState | null> => {
 ...
 */
export const loadSkill = async (name: string): Promise<(Skill & { instructions: string }) | null> => {
