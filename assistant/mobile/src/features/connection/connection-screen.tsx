...
import { testApiConnection } from "../../api.ts";
import { Button, Field } from "../../components/controls.tsx";
import { normalizeApiUrl, saveApiUrl } from "../../platform/connection-storage.ts";
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.container}>
        <View style={styles.content}>
          <View style={styles.logo}>
            <Server color={colors.primary} size={28} />
          </View>
