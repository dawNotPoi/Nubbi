...
export function ParticipantMedia({ participant, localVideoRef }: ParticipantMediaProps): ReactElement {
  ...
  return <div className="relative size-full min-h-28 overflow-hidden rounded-xl bg-bg-selected">
    ...
    <div className="absolute bottom-2 left-2 right-2 flex items-center gap-2 rounded-lg bg-white px-2 py-1 text-sm text-text-primary">
