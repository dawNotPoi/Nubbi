    ...
    <div>
      {Array.from({ length: 8 }).map((_, index) => (
        <div
          ...
          key={index}
        >
          <div className="mx-auto size-3 rounded-compact bg-[#e6e4e1]" />
          <div className="h-3 w-3/5 rounded-compact bg-skeleton md:w-44" />
          <div className="hidden h-3 w-20 rounded-compact bg-skeleton md:block" />
          <div />
        </div>
      ))}
    </div>
