...
export const createMeetingBodySchema = z
  .object({
    ...
    duration: z.coerce.number().int().min(1).max(24 * 60),
    password: z.string().max(200).optional(),
  })
  .strict();

export const meetingIdQuerySchema = z
  .object({ id: meetingIdSchema })
  .strict();

export const deleteMeetingQuerySchema = z
  .object({ _id: meetingIdSchema })
  .strict();

export const validateMeetingAccessBodySchema = z
  .object({
    id: meetingIdSchema,
